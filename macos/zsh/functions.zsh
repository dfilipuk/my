...
calculate_statisitcs () {
    awk 'BEGIN {fsize = 0; fcount = 0} { if ($3 ~ /^-/) {fsize += $7; fcount += 1} else if ($3 ~ /^d/) {dcount += 1} } END {dcount -= 1; printf "\033[1;35m%5d \033[1;33m%7d \033[1;32m%15d \033[0m", dcount, fcount, fsize}'
}